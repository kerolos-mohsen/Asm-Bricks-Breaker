...
draw_height:
    ...
    mov ah, 00              ; BIOS function to get key
    int 16h

    cmp al, 27              ; Check if key is ESC
    je exit                 ; If ESC, exit program
    jmp row_loop            ; Infinite loop (Highly recommended to watch it)
    ; WATCH OUT!!!!!!! ---> ; if your eyes are tired, you can comment the previous line or press ESC
    ; crazy one huh?:D ---> ; Try to press anything except ESC
